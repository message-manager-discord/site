...
For message related commands see <Anchor to="docs/message-management">the message management docs</Anchor> and for config related commands see <Anchor to="docs/config">the config docs</Anchor>.
...
The bot should add a new context menu that you can use to add a message, `Add Message`.
...
This is now a much more complicated system, see <Anchor to="/docs/permissions">the permission docs</Anchor> for more info on that.
